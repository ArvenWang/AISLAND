// Loads the compiled Phase 3 map runtime JSON and atlas textures.

import * as PIXI from 'pixi.js';
import type { RuntimeMapData } from '../../../../server/engine/map/runtimeMap';

const BASE = '/generated/maps/island-01';
...
export type MapAssets = {
  ...
  effectMeta: Record<string, unknown>;
};
...
export function loadMapAssets(): Promise<MapAssets> {
  ...
  cache = (async () => {
    const [map, propMeta, charMeta, effectMeta] = await Promise.all([
